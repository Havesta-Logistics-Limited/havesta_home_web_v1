...
export default function HomeChooseUsChunk() {
  ...
  return (
    <div className=" bg-green-radial px-6">
      <div className="border-2 m-auto pt-24 max-w-6xl bg-white/10 backdrop-blur-md  border-white/20 rounded-md shadow-lg  ">
        {/* UPPER PART */}
        ...
        <div className="bg-white flex flex-col justify-center gap-2 sm:grid sm:grid-cols-3 sm:py-8  ">
          {h.why.map((why) => (
            <div className="flex items-start gap-1" key={why.title}>
              <p className="text-harvestaDarkGreen text-3xl border-r-2 border-r-harvestaDarkGreen w-40 flex justify-end items-center py- pr-2 sm:border-r-0  sm:py-0 sm:pr-0 font-bold">
                {why.icon}{" "}
              </p>
