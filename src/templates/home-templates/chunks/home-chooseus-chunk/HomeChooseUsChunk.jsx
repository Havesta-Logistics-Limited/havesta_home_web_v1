...
export default function HomeChooseUsChunk() {
  ...
  return (
    <div className=" bg-green-radial">
      <div className="border-2 m-auto pt-24 max-w-5xl bg-white/10 backdrop-blur-md  border-white/20 rounded-md shadow-lg  ">
        {/* UPPER PART */}
        ...
        <div className="bg-white flex flex-col justify-center gap-2 sm:grid sm:grid-cols-3 sm:py-8  ">
          {h.why.map((why) => (
            <div className="flex items-stretch" key={why.title}>
